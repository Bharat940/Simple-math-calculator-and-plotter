...
int main() {
    std::cout << "==================================================\n";
    std::cout << "MathStudio v0.1.0 Benchmark Suite Baseline\n";
    std::cout << "==================================================\n";
    ...
    results.push_back(bench("Parse 1,000 expressions", []{
    ...
    std::cout << "\nBaseline established for v0.1.0 Foundation Release.\n";
    std::cout << "Historical record saved in benchmarks/benchmark_v0.1.0.md\n";
    return 0;
}
